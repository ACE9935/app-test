      ...
      >
        {
            images.map(o=>
                ...
                <img src={o} className="object-fit-cover w-full h-full shadow-2xl"/>
              </SwiperSlide>
                )
        }
      </Swiper>
